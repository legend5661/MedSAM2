...
class VOSTextDataset(VisionDataset):
    def __init__(
        self,
        transforms,
        training: bool,
...
if __name__ == "__main__":
    # Example usage
    from training.dataset.vos_raw_dataset import BioMed3DDataset
    from training.dataset.vos_sampler import RandomUniformSampler

    video_dataset = BioMed3DDataset(
    ...
    sampler = RandomUniformSampler(num_frames=8, max_num_objects=5) 
    dataset = VOSTextDataset(
        transforms=None,
        training=True,
    ...
    print(dataset._get_datapoint(0))
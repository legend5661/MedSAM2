...
from sam2.modeling.sam2_text import SAM2Base
...
class SAM2Train(SAM2Base):
    ...
    def prepare_prompt_inputs(self, backbone_out, input, start_frame_idx=0):
        ...
        backbone_out["text_inputs_per_frame"] = {}  # {frame_idx: <input_text>}
        for t in init_cond_frames:
            backbone_out["text_inputs_per_frame"][t] = prompt_per_frame[t]
